                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="pills-email" role="tabpanel"
                                    ...
                                    <form method="POST" action="/send-verification-code">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" name="email" id="vertify-email"
                                                placeholder="name@example.com" required>
                                            <label for="vertify-email" class="form-label">電子郵件</label>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                ...
                                <div class="tab-pane fade" id="pills-SMS" role="tabpanel"
                                    ...
                                    <form method="POST" action="/register">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="tel" class="form-control" name="phone" id="vertify-phone"
                                                placeholder="Your Phone Number" required pattern="[0-9]{10}">
                                            <label for="vertify-phone" class="form-label">手機號碼</label>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn btn-primary btn-lg" type="submit">傳送驗證碼</button>
