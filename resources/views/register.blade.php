                                    ...
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label text-secondary" for="iAgree">
                                                我同意<a href="#!" class="link-primary text-decoration-none">本網站條款</a>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end mt-4">
                                        <p class="m-0 text-secondary text-center">已經有帳號了嗎? <a href="#!" class="link-primary text-decoration-none">登入</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
